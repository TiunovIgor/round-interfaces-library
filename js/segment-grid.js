function SegmentGrid() {
    ...
    this.circles_count = 3;
    this.circle_pitch;
    this.circle_width = 1;
    this.circle_color = '#999'; 
    ...
    this.circles_visible = true;    
    this.beams_visible = true;
    
    this.build();
    this.calc();
};

SegmentGrid.prototype = Object.create(Segment.prototype);
SegmentGrid.prototype.constructor = Segment;

SegmentGrid.prototype.build = function() {
...
SegmentGrid.prototype.draw = function() {
    if(this.visible) {        

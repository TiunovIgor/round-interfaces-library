function SegmentEqualizer(id, context, center_x, center_y, inner_radius, thickness, initial_angle, angle) {    
    ...
    this.border_width = 1;
    this.border_color = "rgba(1, 1, 1, 0)";
    ...
    this.values = [];
    this.speed = 0.1; // value change animation speed
...
SegmentEqualizer.prototype.build = function() {
    this.segments = [];
...
SegmentEqualizer.prototype.calc = function() {
    if(this.in_progress) {
...
SegmentEqualizer.prototype.draw = function() {
...
SegmentEqualizer.prototype.changeValues = function(new_values, speed = this.speed, delay = 0) {
    let equalizer = this;
...
SegmentEqualizer.prototype.appear = function(order, lag, direction, duration, delay) {
...
SegmentEqualizer.prototype.checkAppearedSegments = function(segment) {
...
SegmentEqualizer.prototype.disappear = function(order, lag, direction, duration, delay) {
    this.in_progress = true;
...
SegmentEqualizer.prototype.checkDisappearedSegments = function(segment) {  
    if(this.segments.indexOf(segment) < 0) {
        return;
    }
    else {  
...
SegmentEqualizer.prototype.fadeIn = function(order, lag, duration, delay) {
    this.in_progress = true;
...
SegmentEqualizer.prototype.checkFadedInSegments = function(segment) {
    if(this.segments.indexOf(segment) < 0) {
        return;
    }
    else {    
...
SegmentEqualizer.prototype.fadeOut = function(order, lag, duration, delay) {
    this.in_progress = true;
...
SegmentEqualizer.prototype.checkFadedOutSegments = function(segment) {
    if(this.segments.indexOf(segment) < 0) {
        return;
    }
    else {    

function SegmentDotsArrayTimer(id, context, center_x, center_y, inner_radius, thickness, initial_angle = -90, angle = 360) {    
    SegmentDotsArrayProgressBar.apply(this, arguments);
...
SegmentDotsArrayTimer.prototype.build = function() {
    this.dots = [];
...
SegmentDotsArrayTimer.prototype.calc = function() {
    if(this.in_progress) {        
...
SegmentDotsArrayTimer.prototype.draw = function() {
...
SegmentDotsArrayTimer.prototype.valueToActiveIndex = function(value = this.value) {
    let ind = this.dots_count * (value - this.min_value) / (this.max_value - this.min_value);
    ind = Math.floor(ind);
    return ind;
};

SegmentDotsArrayTimer.prototype.countdown = function(new_value, value, delay = 0) {
    let timer = this;
...
SegmentDotsArrayTimer.prototype.start = function() {
    this.in_progress = true;
    this.on_pause = false;
...
SegmentDotsArrayTimer.prototype.pause = function() {
...
SegmentDotsArrayTimer.prototype.stop = function() {

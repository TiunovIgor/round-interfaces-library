function SegmentArrayTimer(id, context, center_x, center_y, inner_radius, thickness, initial_angle = -90, angle = 360) {    
    SegmentArrayProgressBar.apply(this, arguments);
...
SegmentArrayTimer.prototype = Object.create(SegmentArrayProgressBar.prototype);
SegmentArrayTimer.prototype.constructor = SegmentArrayProgressBar;

SegmentArrayTimer.prototype.build = function() {
    this.segments = [];
...
SegmentArrayTimer.prototype.calc = function() {
    if(this.in_progress) {
...
SegmentArrayTimer.prototype.draw = function() {
...
SegmentArrayTimer.prototype.countdown = function(new_value, value, delay = 0) {
    let timer = this;
...
SegmentArrayTimer.prototype.start = function() {
    this.in_progress = true;
    this.on_pause = false;
...
SegmentArrayTimer.prototype.pause = function() {
...
SegmentArrayTimer.prototype.stop = function() {
